...
export function PostModal({ isOpen, onClose, children }) {
    useEffect(() => {
        const handleEsc = (e) => {
    ...
    return ReactDOM.createPortal(
        ...
        >
            <div
                className="bg-gray-200 p-6 rounded-xl shadow-lg w-full max-w-4xl relative mt-10 overflow-y-auto max-h-[90vh]"
